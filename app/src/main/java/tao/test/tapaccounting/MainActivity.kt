...
import tao.test.tapaccounting.ui.main.SharedYearMonthSession
import tao.test.tapaccounting.ui.common.AddBillEntrySheetLauncher
import tao.test.tapaccounting.ui.common.UiMotion
import tao.test.tapaccounting.ui.main.home.HomeFragment
import tao.test.tapaccounting.ui.main.stats.StatsFragment
import tao.test.tapaccounting.ui.main.assets.AssetsFragment
import tao.test.tapaccounting.ui.main.profile.ProfileFragment
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            ...
            val homeViewModel = androidx.lifecycle.ViewModelProvider(this)
                .get(tao.test.tapaccounting.ui.main.home.HomeViewModel::class.java)
            val (sessionYear, sessionMonth) = SharedYearMonthSession.getYearMonth()
            homeViewModel.syncAndLoad(
                bookName = tao.test.tapaccounting.BookAccountManager.getSelectedBook(this),
                year = sessionYear,
                month = sessionMonth,
                timeRange = 0,
                type = 0,
