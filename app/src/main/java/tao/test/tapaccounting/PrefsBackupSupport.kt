...
object PrefsBackupSupport {
    ...
    fun importAll(ctx: Context, root: JSONObject) {
        ...
        if (cmCurrenciesRaw != null) {
            ...
            if (cmList.isNotEmpty()) {
                tao.test.tapaccounting.logic.CurrencyManager.setEnabledCurrencies(ctx, cmList)
            }
        }
    ...
    fun serializeSettings(ctx: Context): String {
        ...
        return JSONObject().apply {
            ...
            put("cm_enabled_currencies_v1", tao.test.tapaccounting.logic.CurrencyManager.getEnabledCurrencies(ctx).joinToString(","))
    ...
    fun serializeSettingsModules(ctx: Context): Map<String, String> {
        ...
        return linkedMapOf(
            ...
            "settings_advanced" to filterSettingsModule(full, "vibrate_feedback_v1", "save_vibrate_v1", "permanent_wakelock_v1", "shizuku_persistence_v1", "shizuku_mode_v1", "logging_enabled_v1", "show_multi_cur_v1", "show_screen_accounting_v1")
        )
    }
