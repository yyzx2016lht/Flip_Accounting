...
import tao.test.tapaccounting.ui.ExchangeRateActivity
import tao.test.tapaccounting.ui.common.UiMotion.applyFormRowPressFeedback
...
class AccountingFormController(
    ...
    private var selectedRefundSourceBill: tao.test.tapaccounting.data.local.entity.Bill? = null
    ...
    private fun setupListeners() {
        ...
        layoutRefundSource?.setOnClickListener {
            ...
            OverlayDialogs.showRefundBillPickerDialog(ctx) { chosenBill ->
                ...
                val symbol = tao.test.tapaccounting.logic.CurrencyManager.getSymbol(chosenBill.currency)
        ...
        btnSave.setOnClickListener { v ->
            ...
            v.animate()
                ...
                .scaleY(0.93f)
                .setDuration(80L)
                .setInterpolator(tao.test.tapaccounting.ui.common.UiMotion.EXIT_EASING)
                .withEndAction {
                    v.animate()
                        .scaleX(1f)
                        .scaleY(1f)
    ...
    private fun handleSave() {
        ...
        scope.launch(Dispatchers.IO) {
            ...
            var latestRefundSource: tao.test.tapaccounting.data.local.entity.Bill? = null
            if (refundSourceBill != null && type == 1 && editingBillId == null) {
                ...
                if (latestRefundSource != null
                    && latestRefundSource.type == tao.test.tapaccounting.data.local.entity.Bill.TYPE_EXPENSE
                    && latestRefundSource.subType != tao.test.tapaccounting.data.local.entity.Bill.SUBTYPE_REFUND) {
                    ...
                    rBill = rBill.copy(
                        subType = tao.test.tapaccounting.data.local.entity.Bill.SUBTYPE_REFUND,
            ...
            if (isNotSync) {
                scope.launch(Dispatchers.IO) {
                    ...
                    for (i in 0 until billsArray.length()) {
                        ...
                        var cat = tao.test.tapaccounting.logic.CategoryNameNormalizer.normalizeForStorage(obj.optString("category_name", ""))
            ...
            if (toA.isNotEmpty()) {
                ...
                if (spType.selectedItemPosition == 2) {
                    scope.launch(Dispatchers.IO) {
                        ...
                        withContext(Dispatchers.Main) {
                            if (asset?.assetCategory == tao.test.tapaccounting.data.local.entity.Asset.CATEGORY_CREDIT_CARD) {
                                spType.setSelection(3)
                            }
                        }
                    }
