...
import tao.test.tapaccounting.data.local.entity.AiRule as DbAiRule
...
object AIService {
    ...
    val RULE_EXTRACT_PROMPT_DEFAULT              get() = tao.test.tapaccounting.logic.RuleDialogHelper.DEFAULT_RULE_PROMPT
     ...
     */
    private fun applyLocalRuleOverrideOnResult(root: JSONObject, userInput: String, allRules: List<tao.test.tapaccounting.data.local.entity.AiRule>) {
