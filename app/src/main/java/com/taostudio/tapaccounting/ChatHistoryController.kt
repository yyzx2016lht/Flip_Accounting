...
class ChatHistoryController(
    ...
    private val parseBillsFromMessageContent: (String) -> List<com.taostudio.tapaccounting.data.local.entity.Bill>,
    ...
    private val mergeChatBillSnapshots: (
        List<com.taostudio.tapaccounting.data.local.entity.Bill>,
        List<com.taostudio.tapaccounting.data.local.entity.Bill>
    ) -> List<com.taostudio.tapaccounting.data.local.entity.Bill>,
